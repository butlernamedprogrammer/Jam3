...
namespace Opsive.Shared.Input
{
    ...
    public class ActiveInputEvent
    {
        ...
        public bool HasButtonEvent(IPlayerInput playerInput)
        {
        ...
        /// </summary>
        /// <param name="playerInput">A reference to the input component.</param>
        /// <returns>True if the AxisInputMap is using an axis.</returns>
        public bool HasAxisEvent(IPlayerInput playerInput)
        {
            if (m_InputType == Type.Axis && playerInput.GetAxisRaw(m_InputName) != 0) {
                return true;
            }
            return false;
        }
        ...
        public float GetAxisValue(IPlayerInput playerInput)
        {
