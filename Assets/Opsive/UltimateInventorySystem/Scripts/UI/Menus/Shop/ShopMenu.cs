...
namespace Opsive.UltimateInventorySystem.UI.Menus.Shop
{
    ...
    public class ShopMenu : InventoryPanelBinding
    {
        ...
        [SerializeField] protected internal ShopBase m_Shop;
        ...
        [SerializeField] protected internal MultiCurrencyView m_TotalPrice;
        ...
        protected ICurrencyOwner<CurrencyCollection> m_ShopperClientCurrencyOwner;
        ...
        /// </summary>
        protected virtual void OpenBuy()
        {
        ...
        /// </summary>
        protected virtual void OpenSell()
        {
        ...
        protected virtual CurrencyCollection GetPrice(ItemInfo itemInfo)
        {
        ...
        protected virtual void DrawPriceTo(ItemInfo itemInfo, MultiCurrencyView multiCurrencyView)
        {
        ...
        protected virtual void QuantityPickerAmountChanged(int quantity)
        {
        ...
        /// </summary>
        protected virtual void SetModifierUIs()
        {
