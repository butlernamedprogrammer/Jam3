...
namespace Opsive.UltimateInventorySystem.UI.Panels
{
    ...
    public class DisplayPanel : MonoBehaviour
    {
        ...
        [Tooltip("The Event invoked when the panel is opened.")]
        [SerializeField] protected UnityEvent OnPanelOpen;
        [Tooltip("The Event invoked when the panel is closed.")]
        [SerializeField] protected UnityEvent OnPanelClose;
        [Tooltip("The Event invoked when the panel is opened while it was already opened.")]
        [SerializeField] protected UnityEvent OnPanelOpenBack;
