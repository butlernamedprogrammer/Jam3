...
namespace Opsive.UltimateInventorySystem.UI.Panels.Hotbar
{
    ...
    public class ItemSlotCollectionView : ItemViewSlotsContainer, IDatabaseSwitcher
    {
        ...
        [SerializeField] protected ItemViewSlot[] m_ItemSlotItemViewSlots;
        ...
        public ItemViewSlot[] ItemSlotItemViewSlots {
            get { return m_ItemSlotItemViewSlots; }
            protected internal set
            {
                m_ItemSlotItemViewSlots = value;
            }
        }
        
        protected override ItemViewSlot[] RetrieveItemViewSlots()
        {
            var resizeSuccess = ResizeItemViewSlotsToItemSlotsSetCount();
